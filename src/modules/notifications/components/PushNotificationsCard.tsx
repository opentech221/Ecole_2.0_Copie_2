      ...
      <CardContent className="space-y-4 p-5">
        ...
        <div className="grid gap-3 md:grid-cols-3">
          ...
          <div className="rounded-xl border border-slate-200/70 p-3 dark:border-slate-800">
            ...
            <p className="text-sm font-semibold">{status.hasSubscription ? "Détecté" : "Absent"}</p>
          </div>
          <div className="rounded-xl border border-slate-200/70 p-3 dark:border-slate-800">
        ...
        <div className="flex flex-wrap gap-2">
          {!status.subscriptionEnabled ? (
            <Button disabled={loading || enabling || !status.pushConfigured} onClick={onEnable}>
          ...
          <Button variant="secondary" disabled={loading || testing || !status.subscriptionEnabled} onClick={onTest}>
